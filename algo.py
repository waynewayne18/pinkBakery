...
class Algo:
    ...
    # get last 30 rows of real data as history buffer
    # need 30 rows minimum for lag_30 and rolling_30
        ...
        for product in ['croi', 'cappy', 'ameri']:
            ...
            product_encoded = product_history['product_encoded'].iloc[0]
            ...
            for day in range(1, days + 1):
                ...
                # get recent values for lag and rolling calculation
                ...
                # predict
                X_future = pd.DataFrame([row])[self.features]
                pred = self.models[product].predict(X_future)[0]
    ...
    def Predictor(self):
        ...
        for product in ['croi', 'cappy', 'ameri']:
            ...
            X_train = product_data[self.features][:split]
            X_test  = product_data[self.features][split:]
            y_train = product_data['value'][:split]
            y_test  = product_data['value'][split:]
...
if __name__ == "__main__":
    ...
    print(forecast_df)
    croi_df = forecast_df[forecast_df['product'] == 'croi']
    cappy_df = forecast_df[forecast_df['product'] == 'cappy']
    ameri_df = forecast_df[forecast_df['product'] == 'ameri']